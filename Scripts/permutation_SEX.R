permutation_SEX <-
  function(Input_data) {
    mean_diff_MV_SEX <-
      abs(mean(Input_data$MV_abs[Input_data$Sex ==
                                   "female"]) -
            mean(Input_data$MV_abs[Input_data$Sex ==
                                     "male"]))
    median_diff_MV_SEX <-
      abs(median(Input_data$MV_abs[Input_data$Sex ==
                                     "female"]) -
            median(Input_data$MV_abs[Input_data$Sex ==
                                       "male"]))
